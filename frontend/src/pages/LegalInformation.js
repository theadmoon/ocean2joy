...
import { FaEnvelope, FaPhone, FaMapMarkerAlt, FaFileContract } from 'react-icons/fa';
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-sky-50 border-l-4 border-sky-500 rounded-lg p-6 mb-6">
          ...
          <p className="text-gray-700 text-sm leading-relaxed">
            Ocean2joy operates as a registered Individual Entrepreneur in Georgia. 
            All business activities are conducted in compliance with Georgian tax laws and regulations. 
            We maintain full transparency in our financial operations and provide proper documentation 
            for all transactions (invoices, receipts, certificates of delivery).
          </p>
        </div>
