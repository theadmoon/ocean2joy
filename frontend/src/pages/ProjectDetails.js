      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Order Request Summary - What client submitted */}
            <div className="card-ocean p-6 bg-gradient-to-br from-teal-50 to-sky-50">
              ...
              <p className="text-sm text-gray-600 mb-4 text-left">
                Summary of information you provided when creating this order:
              </p>
              
              <div className="space-y-3">
                {/* Service Type */}
                <div className="bg-white rounded-lg p-4">
                  <p className="text-xs font-semibold text-gray-500 mb-1">SERVICE TYPE</p>
                  <p className="text-sm text-gray-900 font-medium">{project.service_type}</p>
                </div>
                ...
                {project.order_activated_at && (
                  <div className="bg-white rounded-lg p-4">
                    <p className="text-xs font-semibold text-gray-500 mb-1">ORDER ACTIVATED</p>
                    <p className="text-sm text-gray-900 font-medium">
                      {new Date(project.order_activated_at).toLocaleString('en-US', {
                        year: 'numeric',
                        month: 'long',
                ...
                {/* Created Date */}
                <div className="bg-white rounded-lg p-4">
                  <p className="text-xs font-semibold text-gray-500 mb-1">REQUEST SUBMITTED</p>
                  <p className="text-sm text-gray-900 font-medium">
              ...
              <div className="mt-4 p-3 bg-teal-100 border border-teal-200 rounded-lg">
                <p className="text-xs text-teal-900 text-left">
                  <strong>Note:</strong> All information above was provided by you. You can edit your Brief anytime in the Project Details section above.
                </p>
              </div>
            </div>
